        ...
        <div
            ...
            <a href="/" class="xl:hidden">
                <div class="flex items-center gap-2">
                    <svg class="fill-brand-500" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
                        <path d="M27.96 12.95C27.45 6.05 21.95.55 15.05.04V5.04a7.91 7.91 0 0 0 7.91 7.91h5ZM12.95 22.96v5c-6.9-.5-12.4-6-12.91-12.91H5.04a7.91 7.91 0 0 1 7.91 7.91Zm10-7.91h5c-.5 6.9-6 12.4-12.91 12.91v-5a7.91 7.91 0 0 1 7.91-7.91ZM.04 12.95C.55 6.05 6.05.55 12.95.04V5.04a7.91 7.91 0 0 1-7.91 7.91H.04Z" />
                    </svg>
                    <span class="text-lg font-bold text-gray-800 dark:text-white">URMIN</span>
                </div>
            </a>
