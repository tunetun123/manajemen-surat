@php
    ...
    $appName = $setting ? $setting->app_name : 'URMIN';
    $appSubtitle = $setting ? $setting->app_subtitle : '';
    $appInstitutionName = $setting ? $setting->institution_name : '';
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/">
            <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                ...
                @if ($logoUrl)
                    <img src="{{ $logoUrl }}" alt="Logo" class="w-14 h-14 object-contain">
                @else
                    <svg class="fill-brand-500" xmlns="http://www.w3.org/2000/svg" width="32" height="32">
                        <path
                ...
                <div class="flex flex-col">
                    <span
                        class="text-xl font-bold text-gray-800 dark:text-white leading-tight">{{ $appName }}</span>
                    @if ($appSubtitle)
                        <span
                            class="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight whitespace-normal max-w-[140px]">{{ $appSubtitle }}</span>
                    @endif
                    @if ($appInstitutionName)
                        <span
                            class="text-[10px] text-gray-500 dark:text-gray-400 font-medium leading-tight whitespace-normal max-w-[140px]">{{ $appInstitutionName }}</span>
                    @endif
                </div>
            </div>
            <div x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen">
